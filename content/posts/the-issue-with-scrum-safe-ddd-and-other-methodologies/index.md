...
I called one of my friend who does bath room renovations, and the following steps happened:
...
As they only have an external view of these solutions, they lack the intimate intricacies that lay underneath the surface, so they might pick the wrong kind of solution/product to start with.
...
Clients associate a methodology with success rates, thinking it is a [silver bullet][9] (i.e. using it will guarantee success in all contexts).

However, there is always a context where a methodology works, and where it does not work at all.
...
Nevertheless, I hope this post influences your approach a little bit when working on your next project.

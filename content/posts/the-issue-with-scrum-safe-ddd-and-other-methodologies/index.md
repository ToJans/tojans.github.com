...
Today I saw someone on Instagram checking out what [SCRUM][1] means - trolling obviously -, and to be honest, it is both hilarious and cringe-worthy (Dutch only):
...
She starts reading about `SCRUM`, and then receives a waterfall (pun intended) of terminology like [Agile][15], [sprints][16], [daily stand-ups][17], [product owners][18], [backlog][19] and so on... Which makes her head hurt...
...
Let's start with the definition of cognitive bias by [Wikipedia][8]:
...
1. He came over to take a look, get some ideas about what we are looking for, expected time-frames etc;
...
5. He provided me a rough estimate of a couple of days, given not too much unexpected things occurred;
6. We confirmed;
7. He ordered;
...
I guess estimating things is really hard ;).
